...
unsigned char keypad(){
    ...
    PORTBbits.RB0 = 1;
    if(PORTBbits.RB3 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 1;}
    if(PORTBbits.RB4 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 4;}
    if(PORTBbits.RB5 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 7;}
    if(PORTBbits.RB6 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 15;}
    PORTBbits.RB0 = 0;

    PORTBbits.RB1 = 1;
    if(PORTBbits.RB3 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 2;}
    if(PORTBbits.RB4 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 5;}
    if(PORTBbits.RB5 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 8;}
    if(PORTBbits.RB6 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 0;}
    PORTBbits.RB1 = 0;

    PORTBbits.RB2 = 1;
    if(PORTBbits.RB3 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 3;}
    if(PORTBbits.RB4 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 6;}
    if(PORTBbits.RB5 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 9;}
    if(PORTBbits.RB6 == 1) {_delay((unsigned long)((20)*(4000000/4000.0))); key = 255;}
    PORTBbits.RB2 = 0;
