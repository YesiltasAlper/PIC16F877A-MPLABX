...
void __interrupt()kesme(){
    ...
    if(PIR1bits.CCP1IF){
        PORTB = (unsigned char)CCPR1;
    }

    // TMR1 = 0;               // Eger her RC2'ye bastigimizda en bastan saysin istersek aktif ederiz.
...
int main() {
    ...
    T1CONbits.TMR1CS = 1;   // TMR1 sayici olarak ayarlandi
    ...
    CCP1CONbits.CCP1M0 = 1; // Bu kodlarin 4 tanesi CCP'nin modunu
    CCP1CONbits.CCP1M1 = 0; // ayarlar.Bu ayarlar yapilarak her yukselen
    CCP1CONbits.CCP1M2 = 1; // kenarda Capture kesmesi olusmasi istendi
    CCP1CONbits.CCP1M3 = 0; // CCP1CONbits.CCP1M = 5; de yazilabilirdi
    
    TMR1 = 1;     // TMR1 deger baslangici      
    CCPR1 = 0;    // CCPR1 clear edildi.
